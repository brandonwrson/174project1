...
class LogRecovery {
 public:
  LogRecovery(DiskManager *disk_manager, BufferPoolManagerInstance *buffer_pool_manager)
 ...
 private:
  ...
  BufferPoolManagerInstance *buffer_pool_manager_ __attribute__((__unused__));
